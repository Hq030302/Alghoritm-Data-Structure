...
using namespace std;
//Deklarasi node untuk data pakaian
struct Node{
    int Ukuran;
    int kodepakaian;
    char warna[50];
...
//Mengganti nama variable Node menjadi Pakaian
typedef Node *Pakaian;
Pakaian Head, Tail, Main;//Deklarasi variabel untuk node yg akan dioperasikan

void inisialisasi();//Prorotipe fungsi inisialisasi awal (pembentukan awal linked list)
void buatpakaian();//Prototipe fungsi penambahan node Pakaian pakaian
void ambilpakaian();//Prototipe fungsi penghapusan node pakaian
void tampilkan();//Prototipe fungsi penampilan node pakaian
void detail();//Prototipe fungsi pencarian dan penampilan detail node pakaian
...
{
    //main menu
   char pil; //variable pemilihan aktivitas pada main menu
   inisialisasi(); //inisialisasi awal
   awal: //untuk kembali ke menu
   cout<<"=================================="<<endl;
   ...
   cout<<"5. Out"<<endl;
    //untuk memasukkan pilihan aktivitas pada menu
...
void buatpakaian()
{
    ...
    else
    {
        ...
        system("cls");
        cout<<"Masukkan kode sesuai format!!"<<endl;
        goto ulang;
    }
...
void tampilkan()
{
 if((Head==NULL)&&(Tail==NULL))
 {
      cout<<"MAAF! Pakaian Tidak Tersedia/Belum Pernah Terisi! Silahkan Diisi terlebih dahulu"<<endl;
 }
 else{
 Main = Head;
 cout<<"=======================================================\n";
 ...
 cout<<"=======================================================\n";
  while(Main!=NULL){
   cout<<"| "<<setiosflags(ios::left)<<setw(7)<<Main->kodepakaian<<"|";
   cout<<" "<<setiosflags(ios::left)<<setw(29)<<Main->namapakaian<<"|";
   if((Main->kodepakaian>=1000)&&(Main->kodepakaian<=1999))
   {cout<<" "<<setiosflags(ios::left)<<setw(12)<<"Atasan"<<"|";}
   else if((Main->kodepakaian>=2000)&&(Main->kodepakaian<=2999))
   {cout<<" "<<setiosflags(ios::left)<<setw(12)<<"Bawahan"<<"|";}
   cout<<"\n=======================================================\n";
   Main = Main->next;
     }
 }
